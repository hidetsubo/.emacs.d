requires=rdoc.constant,rdoc.context,rdoc.token_stream,rdoc,rdoc.parser.ruby,rdoc.anon_class,rdoc.stats,irb.slex,rdoc.alias,rdoc.normal_class,rdoc.top_level,rdoc.known_classes,irb.notifier,rdoc.any_method,rdoc.normal_module,e2mmap,rdoc.meta_method,rdoc.code_object,irb.output=2dmethod,rdoc.code_objects,rdoc.require,rdoc.attr,rdoc.ghost_method,rdoc.single_class,rdoc.class_module,rdoc.parser,rdoc.parser.simple,rdoc.include
category=
methods=
sublibraries=
