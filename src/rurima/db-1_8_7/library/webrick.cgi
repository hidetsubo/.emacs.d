requires=webrick.config,webrick.utils,webrick.httprequest,webrick.httpresponse,webrick.htmlutils,webrick.httpstatus,webrick.cookie,webrick.log,webrick.httpversion,webrick.httputils
sublibraries=
is_sublibrary=true
category=
methods=
